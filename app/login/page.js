...
export default function Login() {
  ...
  // Safe way to read URL errors without useSearchParams (avoids client-side crash)
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (urlError === "server_error") setError("Server error during sign-in. Please try again.");
    }
  }, []);
